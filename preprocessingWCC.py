...
data.convert_to_int(["Q8a","Q8b","Q8c","Q8d","Q8e","Q8f"], "Council Services, Q8")
data.convert_to_int(["Q12a","Q12b","Q12c","Q12d","Q12e","Q12f","Q12g","Q12h","Q12i","Q12j","Q12k","Q12l"], "Publications, Q12")
data.convert_to_int(["Q14a","Q14b","Q14c","Q14d","Q14e","Q14f","Q14g","Q14h","Q14i","Q14j","Q14k","Q14l","Q14m"],"Resource Access, Q14")
data.convert_to_int(["Q26a","Q26b","Q26c","Q26d","Q26e","Q26f","Q26g","Q26h","Q26i","Q26j","Q26k"], "Financial Worry, Q26")
data.convert_to_bool(['Q37a'], "UK Nationality,Q37a")
data.convert_to_bool(['Q29'], "Q29", YesNo=True)
...
data.dataframe.to_csv(os.path.join(_preprocesseddir,"WCCSurvey_mob.csv"))